...
- Reference Performance Gate：在完整记录硬件、OS、SQLite、缓存状态、并发和样本的官方参考机上，500,000 WorkProjection（推荐正式验证规模，见 `Documents/指南/02-测试与发布门禁.md`「正式验证规模分级」）、1%/10%/50% 变化时发布事务 P95 均小于 250 ms；≥1,000,000 属于非推荐诊断场景，只作方向性证据；
