...
const (
	...
	CATALOGCANDIDATEALREADYPUBLISHED ErrorCode = "CATALOG_CANDIDATE_ALREADY_PUBLISHED"
...
func (e ErrorCode) Valid() bool {
	...
	case BINDINGREVIEWREQUIRED:
		return true
	case CATALOGCANDIDATEALREADYPUBLISHED:
		return true
...
type ListWorksParams struct {
	...
	// Filter 服务端权威结构化过滤 AST 的 JSON 编码：{"all"|"any"|"not"|"field"/"op"/"value"}。 未知字段、未知操作符或类型错误一律返回 VALIDATION_ERROR。已注册字段与语义见 docs/architecture/query-search-and-sorting.md。
