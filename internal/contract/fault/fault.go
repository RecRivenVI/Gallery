...
const (
	...
	CodeDerivedAssetUnavailable    Code = "DERIVED_ASSET_UNAVAILABLE"
	CodeDerivedAssetFailed         Code = "DERIVED_ASSET_FAILED"
	CodeExternalToolUnavailable    Code = "EXTERNAL_TOOL_UNAVAILABLE"
	...
	CodeContentChanged             Code = "CONTENT_CHANGED"
	CodeMediaOffline               Code = "MEDIA_OFFLINE"
	CodeMediaReadBusy              Code = "MEDIA_READ_BUSY"
	...
	CodeLANOwnerRequired           Code = "LAN_OWNER_REQUIRED"
	CodeLANAlreadyInitialized      Code = "LAN_ALREADY_INITIALIZED"
	...
	CodeRuleDraftConflict          Code = "RULE_DRAFT_CONFLICT"
	CodeRulePackageConflict        Code = "RULE_PACKAGE_CONFLICT"
	CodeRuleParameterConflict      Code = "RULE_PARAMETER_CONFLICT"
	CodeRulePublishBlocked         Code = "RULE_PUBLISH_BLOCKED"
	CodeRuleRollbackBlocked        Code = "RULE_ROLLBACK_BLOCKED"
	CodeRuleVersionInUse           Code = "RULE_VERSION_IN_USE"
	CodeRuleImportInvalid          Code = "RULE_IMPORT_INVALID"
	CodeRuleBindingConflict        Code = "RULE_BINDING_CONFLICT"
	CodeJobStateConflict           Code = "JOB_STATE_CONFLICT"
	CodeJobProgressRegression      Code = "JOB_PROGRESS_REGRESSION"
	CodeJobRetryExhausted          Code = "JOB_RETRY_EXHAUSTED"
	CodeJobCancellationRequested   Code = "JOB_CANCELLATION_REQUESTED"
	CodeScanAlreadyRunning         Code = "SCAN_ALREADY_RUNNING"
	CodeContentHashPending         Code = "CONTENT_HASH_PENDING"
	CodeDiskSpaceInsufficient      Code = "DISK_SPACE_INSUFFICIENT"
	CodeMaintenanceBlocked         Code = "MAINTENANCE_BLOCKED"
	CodeWatcherOverflow            Code = "WATCHER_OVERFLOW"
	CodeSourceIdentityChanged      Code = "SOURCE_IDENTITY_CHANGED"
	CodeSourcePermissionDenied     Code = "SOURCE_PERMISSION_DENIED"
	...
	CodeVerificationTargetMismatch Code = "VERIFICATION_TARGET_MISMATCH"
	CodePathEscape                 Code = "PATH_ESCAPE"
	CodeCatalogCandidateInvalid    Code = "CATALOG_CANDIDATE_INVALID"
	CodeCatalogCandidatePublished  Code = "CATALOG_CANDIDATE_ALREADY_PUBLISHED"
